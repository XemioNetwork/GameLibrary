...
{
    public class DrawPieEvent : RegionEvent, ICancelableEvent
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="DrawPieEvent"/> class.
        /// </summary>
        /// <param name="pen">The pen.</param>
        /// <param name="region">The region.</param>
        /// <param name="startAngle">The start angle.</param>
        /// <param name="sweepAngle">The sweep angle.</param>
        public DrawPieEvent(IPen pen, Rectangle region, float startAngle, float sweepAngle)
        {
            this.Pen = pen;
            this.Region = region;
