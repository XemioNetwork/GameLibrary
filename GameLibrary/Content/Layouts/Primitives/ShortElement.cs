...
namespace Xemio.GameLibrary.Content.Layouts.Primitives
{
    internal class ShortElement : BaseElement
    {
        ...
        public ShortElement(string tag, PropertyInfo property) : this(tag, property.GetValue, property.SetValue)
        {
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShortElement" /> class.
        ...
        public ShortElement(string tag, Func<object, object> getAction, Action<object, object> setAction) : base(tag, getAction, setAction)
        {
        }
        #endregion
