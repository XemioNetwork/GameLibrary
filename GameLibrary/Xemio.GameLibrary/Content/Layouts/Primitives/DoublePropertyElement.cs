...
{
    internal class DoublePropertyElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public DoublePropertyElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteDouble(this.Tag, (double)this.Property.GetValue(container));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(container, reader.ReadDouble(this.Tag));
        }
        #endregion
    }
}
