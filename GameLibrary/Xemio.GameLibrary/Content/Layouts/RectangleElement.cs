...
{
    public class RectangleElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public RectangleElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteRectangle(this.Tag, (Rectangle)this.Property.GetValue(value));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(value, reader.ReadRectangle(this.Tag));
        }
        #endregion
    }
}
