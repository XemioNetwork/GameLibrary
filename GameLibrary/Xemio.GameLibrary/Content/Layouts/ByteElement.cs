...
{
    public class ByteElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public ByteElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteByte(this.Tag, (byte)this.Property.GetValue(value));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(value, reader.ReadByte(this.Tag));
        }
        #endregion
    }
}
