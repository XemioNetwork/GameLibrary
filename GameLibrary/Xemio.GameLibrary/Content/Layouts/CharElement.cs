...
{
    public class CharElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public CharElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteCharacter(this.Tag, (char)this.Property.GetValue(value));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(value, reader.ReadCharacter(this.Tag));
        }
        #endregion
    }
}
