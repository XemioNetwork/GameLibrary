...
{
    public class BooleanElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public BooleanElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteBoolean(this.Tag, (bool)this.Property.GetValue(value));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(value, reader.ReadBoolean(this.Tag));
        }
        #endregion
    }
}
