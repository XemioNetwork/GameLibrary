...
{
    public class ShortElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public ShortElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteShort(this.Tag, (short)this.Property.GetValue(value));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(value, reader.ReadShort(this.Tag));
        }
        #endregion
    }
}
