...
{
    public class DoubleElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public DoubleElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteDouble(this.Tag, (double)this.Property.GetValue(value));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(value, reader.ReadDouble(this.Tag));
        }
        #endregion
    }
}
