...
{
    public class ClientReceivedPackageEvent : ClientPackageEvent, IInterceptableEvent
    {
        #region Constructors
        /// <summary>
        ...
        public ClientReceivedPackageEvent(IClient client, Package package) : base(client, package)
        {
        }
        #endregion
