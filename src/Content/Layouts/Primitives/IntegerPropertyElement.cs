...
{
    internal class IntegerPropertyElement : PropertyElement
    {
        #region Constructors
        /// <summary>
        ...
        public IntegerPropertyElement(string tag, PropertyInfo property) : base(tag, property)
        {
        }
        #endregion
        ...
        {
            writer.WriteInteger(this.Tag, (int)this.Property.GetValue(container));
        }
        /// <summary>
        ...
        {
            this.Property.SetValue(container, reader.ReadInteger(this.Tag));
        }
        #endregion
    }
}
